...
module.exports = {
  ...
  Answers: new ETL_Options('/csvs/qa/answers.csv', 'Answers', ['int', 'int', 'string'], 6879306),
  Answers_Photos: new ETL_Options('/csvs/qa/answers_photos.csv', 'Answers_Photos', ['int', 'int', 'string', 'datetime', 'string', 'string', 'boolean', 'int'], 2063759),
